...
public class Register {
	...
	public static final List<Block> GROUND_HEADS = VanillaTweaks.CONFIG.MORE_MOB_HEADS.getOdds().getKeys().stream().map(e -> new MobHeadBlock()).collect(Collectors.toList());
